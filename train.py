...
"""
    ...
    dataset = MyDataset(args, dataset.select(range(10)))
    data_loader = DataLoader(dataset, shuffle=False, pin_memory=True, batch_size=args.micro_bsz, num_workers=0, persistent_workers=False, drop_last=True)
