...
"""
    ...
    if(args.OP == 1):
        ...
        dataset = load_from_disk("temp_datasets/ultrachat_speech")#55464
        ...
        data_loader = DataLoader(dataset, shuffle=True, pin_memory=True, batch_size=args.micro_bsz, num_workers=32, persistent_workers=False, drop_last=True, collate_fn=lambda x: x)
